...
// Tue Jan 24 20:20:36 2017 by ROOT version 6.04/10
// from TTree tree/tree
// found on file: run1179.root
// modified by Bae
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           BigRIPSGe_;
   UInt_t          BigRIPSGe_fUniqueID[kMaxBigRIPSGe];   //[BigRIPSGe_]
   UInt_t          BigRIPSGe_fBits[kMaxBigRIPSGe];   //[BigRIPSGe_]
   Int_t           BigRIPSGe_id[kMaxBigRIPSGe];   //[BigRIPSGe_]
   Int_t           BigRIPSGe_fpl[kMaxBigRIPSGe];   //[BigRIPSGe_]
   TString         BigRIPSGe_name[kMaxBigRIPSGe];
   Int_t           BigRIPSGe_fDataState[kMaxBigRIPSGe];   //[BigRIPSGe_]
   Int_t           BigRIPSGe_fADC[kMaxBigRIPSGe];   //[BigRIPSGe_]
   Int_t           BigRIPSGe_fTDC[kMaxBigRIPSGe];   //[BigRIPSGe_]
   Double_t        BigRIPSGe_fEnergy[kMaxBigRIPSGe];   //[BigRIPSGe_]
   Double_t        BigRIPSGe_fTime[kMaxBigRIPSGe];   //[BigRIPSGe_]
   ...
   TBranch        *b_BigRIPSGe_;   //!
   TBranch        *b_BigRIPSGe_fUniqueID;   //!
   TBranch        *b_BigRIPSGe_fBits;   //!
   TBranch        *b_BigRIPSGe_id;   //!
   TBranch        *b_BigRIPSGe_fpl;   //!
   TBranch        *b_BigRIPSGe_name;   //!
   TBranch        *b_BigRIPSGe_fDataState;   //!
   TBranch        *b_BigRIPSGe_fADC;   //!
   TBranch        *b_BigRIPSGe_fTDC;   //!
   TBranch        *b_BigRIPSGe_fEnergy;   //!
   TBranch        *b_BigRIPSGe_fTime;   //!
...
/*#ifdef BigRIPS_cxx
BigRIPS::BigRIPS(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run1179.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run1179.root");
      }
...
void BigRIPS::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("BigRIPSGe", &BigRIPSGe_, &b_BigRIPSGe_);
   fChain->SetBranchAddress("BigRIPSGe.fUniqueID", &BigRIPSGe_fUniqueID, &b_BigRIPSGe_fUniqueID);
   fChain->SetBranchAddress("BigRIPSGe.fBits", &BigRIPSGe_fBits, &b_BigRIPSGe_fBits);
   fChain->SetBranchAddress("BigRIPSGe.id", &BigRIPSGe_id, &b_BigRIPSGe_id);
   fChain->SetBranchAddress("BigRIPSGe.fpl", &BigRIPSGe_fpl, &b_BigRIPSGe_fpl);
   fChain->SetBranchAddress("BigRIPSGe.name", &BigRIPSGe_name, &b_BigRIPSGe_name);
   fChain->SetBranchAddress("BigRIPSGe.fDataState", &BigRIPSGe_fDataState, &b_BigRIPSGe_fDataState);
   fChain->SetBranchAddress("BigRIPSGe.fADC", &BigRIPSGe_fADC, &b_BigRIPSGe_fADC);
   fChain->SetBranchAddress("BigRIPSGe.fTDC", &BigRIPSGe_fTDC, &b_BigRIPSGe_fTDC);
   fChain->SetBranchAddress("BigRIPSGe.fEnergy", &BigRIPSGe_fEnergy, &b_BigRIPSGe_fEnergy);
   fChain->SetBranchAddress("BigRIPSGe.fTime", &BigRIPSGe_fTime, &b_BigRIPSGe_fTime);
...
void BigRIPS::GetTsEntry(std::map<Long64_t,Long64_t> &mts)
{  Long64_t ts;
   Long64_t nenties = fChain->GetEntriesFast();
   std::cout<<nenties<<"nenties in BigRIPS "<<std::endl;
   ...
   for(Long64_t jentry = 0;jentry < nenties ;jentry++)
   {
      ...
      if(jentry%100000 ==0 && ts > 0) std::cout<<"jentry = "<<jentry<<" brips ts = "<<EventInfo_timestamp[0]<<" Run number = "<<EventInfo_runnumber[0]<<std::endl;
